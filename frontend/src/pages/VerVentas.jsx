...
export default function VerVentas() {
  ...
  const fetchSales = async () => {
    try {
      ...
      const res = await axios.get('https://gecco-for-kids.onrender.com/api/sales', {
  ...
  const downloadPDFReport = async () => {
    try {
      ...
      const response = await axios.get('https://gecco-for-kids.onrender.com/api/sales/report', {
        headers: { 
