...
export default function AdminPanel() {
  ...
  const fetchProducts = async () => {
    try {
      setIsLoading(true);
      const res = await axios.get('https://gecco-for-kids.onrender.com/api/products');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await axios.put(
          `https://gecco-for-kids.onrender.com/api/products/${editingId}`,
          formData,
        ...
        await axios.post(
          'https://gecco-for-kids.onrender.com/api/products',
          formData,
          { headers: { Authorization: `Bearer ${token}`, 'Content-Type': 'multipart/form-data' } }
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      setIsLoading(true);
      await axios.delete(`https://gecco-for-kids.onrender.com/api/products/${id}`, {
  ...
  const fetchSellers = async () => {
    try {
      ...
      const res = await axios.get('https://gecco-for-kids.onrender.com/api/admin-sellers/sellers', {
        headers: { Authorization: `Bearer ${token}` }
      });
      setSellers(res.data);
    } catch (error) {
  ...
  const fetchSellerClients = async (sellerId) => {
    try {
      ...
      const res = await axios.get(`https://gecco-for-kids.onrender.com/api/admin-sellers/sellers/${sellerId}/clients`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchSellerSales = async (sellerId) => {
    try {
      ...
      const res = await axios.get(`https://gecco-for-kids.onrender.com/api/admin-sellers/sellers/${sellerId}/sales`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  try {
    const res = await axios.get(`https://gecco-for-kids.onrender.com/api/sales/admin/report/${selectedSeller._id}`, {
